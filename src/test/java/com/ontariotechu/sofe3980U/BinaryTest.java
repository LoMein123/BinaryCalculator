...
public class BinaryTest 
{
    ...
    public void or2()
    {
        Binary binary1 = new Binary("110101");
        Binary binary2 = new Binary("1101");
        Binary result = Binary.or(binary1, binary2);

        assertTrue(result.getValue().equals("111101")); // It should sign extend the shorter binary number with 0
    }
    /**
     * Test The OR functions with both binary numbers as 0
     */
    @Test
    public void or3()
    {
    ...
    public void and2()
    {
        ...
        assertTrue(result.getValue().equals("101")); // It should sign extend the shorter binary number with 0
    }
    /**
     * Test the AND functions with both binary numbers as 0
     */
    @Test
    public void and3()
    {
    ...
    public void multiply1()
    {
        ...
        assertTrue(result.getValue().equals("1101000"));    // 8 * 13 = 104
    }
    /**
     * Test the multiply functions with two binary numbers of different length
     */
    @Test
    public void multiply2()
    {
        ...
        assertTrue(result.getValue().equals("1010110001"));    // 53 * 13 = 689
    }
    /**
     * Test the multiply functions with both binary numbers as 0
     */
    @Test
